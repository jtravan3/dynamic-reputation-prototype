...
- Fixed execution flag from preventing all use cases from running

## [2.1.8]

### Changed

- Removed incrementing transaction count on compensation transactions
- Added the ability to execute multiple use cases at once
